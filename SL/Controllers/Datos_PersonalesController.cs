...
namespace SL.Controllers
{
    public class Datos_PersonalesController : ApiController
    {
        ...
        public IHttpActionResult GetById(int ID)
        {
            ...
            ML.Response.Datos_PersonalesResponse request = BL.Datos_Personales.GetById(ID);
        ...
        [HttpPut]
        [Route("api/Update/")]
        public IHttpActionResult Update(ML.Entities.Datos_Personales datos_Personales)
        {

            ML.Response.Datos_PersonalesResponse request = BL.Datos_Personales.Update(datos_Personales);
