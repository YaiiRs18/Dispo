...
namespace BL
{
    public class Datos_Personales
    {
        ...
        public static ML.Response.Datos_PersonalesResponse GetById(int ID)
        {
            ML.Response.Datos_PersonalesResponse response = new ML.Response.Datos_PersonalesResponse();
            try
            {
                using (DL.DisponibilidadHorariosEntities1 context = new DL.DisponibilidadHorariosEntities1())
                {
                    var GetAll = context.SP_Datos_Personales_GetById(ID);
        ...
        public static ML.Response.Datos_PersonalesResponse Update(ML.Entities.Datos_Personales datos_Personales)
        {
            ML.Response.Datos_PersonalesResponse response = new ML.Response.Datos_PersonalesResponse();
            try
            {
                using (DL.DisponibilidadHorariosEntities1 context = new DL.DisponibilidadHorariosEntities1())
                {
                    var Add = context.SP_Datos_Personales_Editar(datos_Personales.Id_Datos_Personales,datos_Personales.Nombre, datos_Personales.APaterno, datos_Personales.AMaterno,
           datos_Personales.Edad,
           datos_Personales.Lugar_de_Nacimiento,
           datos_Personales.Estado_Civil,
           datos_Personales.CURP,
